    ...
    <section className="container mx-auto px-5 lg:px-14 max-w-7xl mt-32 lg:mt-36 flex">
      ...
      `}>
        ...
        <motion.div
          ...
          className="relative aspect-570/650 lg:max-w-120 m-5">
          <Image
